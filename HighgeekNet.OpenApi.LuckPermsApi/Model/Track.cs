...
namespace HighgeekNet.OpenApi.LuckPermsApi.Model
{
    ...
    public partial class Track : IValidatableObject
    {
        /// <summary>
        ...
        public Track(string name = default(string), List<string> groups = default(List<string>))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for Track and cannot be null");
            }
            this.Name = name;
            // to ensure "groups" is required (not null)
            if (groups == null)
            {
                throw new ArgumentNullException("groups is a required property for Track and cannot be null");
            }
            this.Groups = groups;
        }

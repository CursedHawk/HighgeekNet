...
public partial class McserverMaindbContext : DbContext
{
    ...
    public virtual DbSet<SrCooldown> SrCooldowns { get; set; }

    public virtual DbSet<SrCustomSkin> SrCustomSkins { get; set; }

    public virtual DbSet<SrPlayer> SrPlayers { get; set; }

    public virtual DbSet<SrPlayerFavourite> SrPlayerFavourites { get; set; }

    public virtual DbSet<SrPlayerHistory> SrPlayerHistories { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<SrCooldown>(entity =>
        {
            entity.HasKey(e => new { e.Uuid, e.GroupName })
                .HasName("PRIMARY")
                .HasAnnotation("MySql:IndexPrefixLength", new[] { 0, 0 });

            entity
                .ToTable("sr_cooldowns")
                .HasCharSet("utf8mb3")
                .UseCollation("utf8mb3_general_ci");
        ...
        modelBuilder.Entity<SrPlayerFavourite>(entity =>
        {
            entity.HasKey(e => new { e.Uuid, e.Timestamp })
                .HasName("PRIMARY")
                .HasAnnotation("MySql:IndexPrefixLength", new[] { 0, 0 });

            entity
                .ToTable("sr_player_favourites")
                .HasCharSet("utf8mb3")
                .UseCollation("utf8mb3_general_ci");
        ...
        modelBuilder.Entity<SrPlayerHistory>(entity =>
        {
            entity.HasKey(e => new { e.Uuid, e.Timestamp })
                .HasName("PRIMARY")
                .HasAnnotation("MySql:IndexPrefixLength", new[] { 0, 0 });
        ...
        modelBuilder.Entity<WebMinecraftuser>(entity =>
        {
            entity.HasKey(e => e.Uuid).HasName("PRIMARY");
